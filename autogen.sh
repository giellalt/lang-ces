...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_ces to login script."
...
# the current dir:
if   test x${GTLANG_ces} = x ; then
	echo "WARNING: The variable \${GTLANG_ces} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_ces} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_ces} has the value:"
	echo "  ${GTLANG_ces}"
