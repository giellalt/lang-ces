...
This directory contains source files for the Czech language morphology
...
-   <https://giellalt.uit.no/tools/docu-ces-manual.html>
-   <https://giellalt.uit.no/index.html>

Requirements
------------

In order to compile and use Czech language morphology and dictionaries,
you need:
...
The Czech language sources can be acquired using [giella SVN
